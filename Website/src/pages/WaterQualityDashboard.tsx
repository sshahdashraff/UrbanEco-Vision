      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border-2 border-[#5c986a]/20 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-[#1a5059] dark:text-white">Water Quality Dashboard</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border-2 border-[#5c986a]/20 dark:border-gray-700">
            ...
            <h3 className="text-4xl font-bold text-[#1a5059] dark:text-white mb-1">{waterResults.wqi}</h3>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border-2 border-[#84f4e6]/20 dark:border-gray-700">
            ...
            <h3 className="text-4xl font-bold text-[#1a5059] dark:text-white mb-1">{waterResults.parameters.pH.value}</h3>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border-2 border-[#5c986a]/20 dark:border-gray-700">
            ...
            <h3 className="text-4xl font-bold text-[#1a5059] dark:text-white mb-1">{waterResults.parameters.dissolvedOxygen.value}</h3>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border-2 border-[#84f4e6]/20 dark:border-gray-700">
            ...
            <h3 className="text-4xl font-bold text-[#1a5059] dark:text-white mb-1">{waterResults.parameters.TDS.value}</h3>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border-2 border-[#5c986a]/20 dark:border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {waterResults.recommendations.map((rec: string, idx: number) => (
              <div key={idx} className="bg-gradient-to-br from-orange-50 to-yellow-50 dark:from-orange-900/20 dark:to-yellow-900/20 p-4 rounded-xl border border-orange-200 dark:border-orange-800">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-gray-200 dark:border-gray-600">
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-700 dark:text-gray-300">Parameter</th>
                  <th className="text-center py-3 px-4 text-sm font-semibold text-gray-700 dark:text-gray-300">Measured Value</th>
                  <th className="text-center py-3 px-4 text-sm font-semibold text-gray-700 dark:text-gray-300">Standard</th>
                  <th className="text-center py-3 px-4 text-sm font-semibold text-gray-700 dark:text-gray-300">Quality Index</th>
              ...
              <tbody>
                {Object.entries(waterResults.parameters).map(([key, param]: [string, WaterParameter], idx) => {
                  ...
                  return (
                    <tr key={key} className={`border-b border-gray-100 dark:border-gray-600 ${idx % 2 === 0 ? 'bg-gray-50 dark:bg-gray-700/50' : ''}`}>
                      <td className="py-4 px-4 font-medium text-gray-800 dark:text-gray-200 capitalize">{key.replace(/([A-Z])/g, ' $1').trim()}</td>
                      <td className="text-center py-4 px-4 text-gray-700 dark:text-gray-300">{param.value}</td>
                      <td className="text-center py-4 px-4 text-gray-600 dark:text-gray-400 text-sm">{param.standard}</td>
                      ...
                      <td className="text-center py-4 px-4">
                        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                          isGood ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300' : 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300'
                        }`}>
