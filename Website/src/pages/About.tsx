...
const About: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-green-50">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#1a5059] mb-6">Our Mission</h2>
      ...
      {/* Green Goals Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#c5d9a9]/10 to-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-[#1a5059] text-center mb-12">Smart City Outcomes We Aim For</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-2xl shadow-lg text-center border-2 border-[#84f4e6]/30 transform hover:scale-105 transition-all">
              ...
              <h3 className="text-xl font-semibold text-[#1a5059] mb-3">Energy‑Positive Districts</h3>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg text-center border-2 border-[#84f4e6]/30 transform hover:scale-105 transition-all">
              ...
              <h3 className="text-xl font-semibold text-[#1a5059] mb-3">Carbon‑Light Operations</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg text-center border-2 border-[#84f4e6]/30 transform hover:scale-105 transition-all">
              ...
              <h3 className="text-xl font-semibold text-[#1a5059] mb-3">Thriving Communities</h3>
              <p className="text-gray-600">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-[#1a5059] text-center mb-12">Creative Ideas to Build a Smart City</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-[#c5d9a9]/20 to-white p-6 rounded-2xl border-2 border-[#84f4e6]/30 shadow-lg">
              <h3 className="text-xl font-semibold text-[#1a5059] mb-2">Solar Canopies & Cool Corridors</h3>
              <p className="text-gray-700">Turn parking lots and bus stops into shade‑giving power stations that charge e‑mobility and cool streets.</p>
            </div>
            <div className="bg-gradient-to-br from-[#c5d9a9]/20 to-white p-6 rounded-2xl border-2 border-[#84f4e6]/30 shadow-lg">
              <h3 className="text-xl font-semibold text-[#1a5059] mb-2">Digital Water Twins</h3>
              <p className="text-gray-700">Use sensors and AI to spot leaks in hours, optimize pressure, and reuse treated water for urban greening.</p>
            </div>
            <div className="bg-gradient-to-br from-[#c5d9a9]/20 to-white p-6 rounded-2xl border-2 border-[#84f4e6]/30 shadow-lg">
              <h3 className="text-xl font-semibold text-[#1a5059] mb-2">Pocket Forests & Green Roofs</h3>
              <p className="text-gray-700">Plant native micro‑forests and retrofit rooftops to cut heat, capture rain, and create biodiverse havens.</p>
            </div>
            <div className="bg-gradient-to-br from-[#c5d9a9]/20 to-white p-6 rounded-2xl border-2 border-[#84f4e6]/30 shadow-lg">
              <h3 className="text-xl font-semibold text-[#1a5059] mb-2">Waste‑to‑Value Hubs</h3>
              <p className="text-gray-700">Transform organics into compost and biogas; turn recyclables into local materials for urban upgrades.</p>
            </div>
            <div className="bg-gradient-to-br from-[#c5d9a9]/20 to-white p-6 rounded-2xl border-2 border-[#84f4e6]/30 shadow-lg">
              <h3 className="text-xl font-semibold text-[#1a5059] mb-2">Citizen Dashboards</h3>
              <p className="text-gray-700">Open, real‑time dashboards for air, energy, and water so communities can co‑create solutions.</p>
            </div>
            <div className="bg-gradient-to-br from-[#c5d9a9]/20 to-white p-6 rounded-2xl border-2 border-[#84f4e6]/30 shadow-lg">
              <h3 className="text-xl font-semibold text-[#1a5059] mb-2">15‑Minute Services</h3>
              <p className="text-gray-700">Design neighborhoods where daily needs are a short walk or ride away lower traffic, higher life quality.</p>
            </div>
          </div>
        </div>
      </section>
